...
urlpatterns = [
    ...
    path('creating_details/<int:user_id>/', views.PupilDetailsView.as_view(), name='details'),
    path('main/trainer/<int:trainer_id>/', views.TrainerMainView.as_view(), name='main_trainer'),
    path('main/<int:pupil_id>/', views.ThePupilMainView.as_view(), name='main_pupil'),
